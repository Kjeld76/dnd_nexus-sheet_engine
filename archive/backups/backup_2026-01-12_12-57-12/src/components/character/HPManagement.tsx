  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-3">
        ...
        <h3 className="text-lg font-black italic font-serif">Trefferpunkte</h3>
          ...
          {useRolledHP && (
            <div className="pt-4 border-t border-border">
              <p className="text-xs text-muted-foreground italic">
                Du verwendest gewürfelte TP. Die Max TP werden nicht automatisch
                berechnet.
              </p>
            </div>
          )}
      ...
      <div className="bg-card p-6 rounded-2xl border border-border shadow-xl shadow-foreground/[0.02]">
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            {/* Successes */}
            <div className="space-y-2">
              <label className="text-xs font-black text-green-500/70 uppercase tracking-wider">
                Erfolge
              </label>
              <div className="flex items-center gap-2">
                {[1, 2, 3].map((num) => (
            ...
            {/* Failures */}
            <div className="space-y-2">
              <label className="text-xs font-black text-red-500/70 uppercase tracking-wider">
                Fehlschläge
              </label>
              <div className="flex items-center gap-2">
                {[1, 2, 3].map((num) => (
