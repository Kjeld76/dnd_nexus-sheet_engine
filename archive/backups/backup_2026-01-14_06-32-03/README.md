...
- **Automatische Anwendung**:
  ...
  - **Starting Equipment**: Dialog zur Auswahl zwischen Option A oder B (falls vorhanden)
    - Automatisches Hinzufügen gewählter Items zum Inventar
...
- **Hintergrund-Wechsel**: 
  ...
  - Entfernen von Attributswerten (zurückgesetzt auf vorherigen Stand)
  - Entfernen von Feats, Fertigkeiten und Werkzeugen des vorherigen Hintergrunds
  - Entfernen von Starting Equipment Items aus dem Inventar
